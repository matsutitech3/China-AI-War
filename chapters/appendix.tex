...
\begin{table}[htbp]
  ...
  \begin{tabular}{p{42mm}p{16mm}p{13mm}p{31mm}p{31mm}}
    ...
    \addlinespace
    A capacity-first appliance runs a $\geq$2T-parameter open model for four concurrent users at $\geq$40 tokens/s each inside a 1\,kW envelope, at a system price below \$12k (\S\ref{sec:appliance-cost}) & 35\% & 3--5 yrs & published measurements on shipping hardware & the configuration remaining above \$30k, or below 20 tok/s per user at four users, through 2030 \\
    \addlinespace
