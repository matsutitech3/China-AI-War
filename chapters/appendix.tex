...
Three developments in the week to \datafreeze\ belong to Chapter~\ref{ch:trade} rather than to the model chronology, and together they describe the trade acquiring market infrastructure.

\emph{NVIDIA mobilizes third-party capital (10 August).} Memoranda of understanding with Apollo, BlackRock, Blackstone, Brookfield, Goldman Sachs and KKR to establish compute financing platforms targeting over \$500B of third-party capital ``over time,'' subject to final agreements; the subhead's object is turning NVIDIA compute into ``an investable asset class''~\cite{nvidia-500b}. Four days later, reporting had NVIDIA cutting its contemplated backstop of OpenAI's Ohio campus from roughly \$250B to under \$120B after investors raised concerns about its risk exposure~\cite{nvidia-backstop-cut}. Read together: exposure relocating from the vendor's balance sheet to institutional capital.
