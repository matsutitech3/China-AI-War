...
\begin{table}[htbp]
  ...
  \begin{tabular}{p{42mm}p{16mm}p{13mm}p{31mm}p{31mm}}
    ...
    \addlinespace
    HBF-class silicon ships in volume with published endurance, latency and energy-per-bit figures at or below $\sim$10\,pJ/bit (\S\ref{sec:memoryunlock}) & 40\% & 2--4 yrs & vendor datasheets; independent measurement; OCP conformance scheme & no volume product by 2029, or measured energy above $\sim$20\,pJ/bit, which would make a local weights-in-flash machine thermally infeasible \\
    \addlinespace
    A capacity-first appliance runs a frontier-scale open model ($\geq$1T parameters) at $\geq$30 tokens/s for a single user inside a 1.5\,kW envelope, at a system price below \$50k & 35\% & 3--5 yrs & published measurements on shipping hardware & the configuration remaining above \$150k or outside the thermal envelope through 2030 \\
    \addlinespace
