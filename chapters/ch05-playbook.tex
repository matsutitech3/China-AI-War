...
Before turning to AI, it is worth compressing the three surveys into the invariant structure. Table~\ref{tab:playbook} aligns the moves across the three won wars and their emerging AI equivalents; the telecommunications campaign of Chapter~\ref{ch:telecom} fits every row with one instrument the table does not show, sovereign vendor credit, and is omitted from it only because the table is about commodities; the rest of this short chapter states the mechanism in general form.
