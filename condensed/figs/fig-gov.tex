...
\node[font=\scriptsize\color{inkSec}, align=left, anchor=north west, text width=132mm]
  ...
  actor governs the arena that the argument of the trust and security chapters shows matters most.};
\end{tikzpicture}
...
the one whose absence the security chapter shows to be systemically consequential, and it is unowned.}
\label{fig:gov}
\end{figure}
