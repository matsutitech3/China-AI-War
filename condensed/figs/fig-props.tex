...
\node[font=\scriptsize\color{inkSec}, align=left, text width=146mm, below=25mm of p2.south, xshift=13mm]
  {\textbf{None of these arrows is entailment.} P1 can hold while P2 fails (dominance on stockpiled foreign
   ...
   elasticity case); and P4 could arrive from macro causes with none of P1--P3 mattering.
...
coupling between them rather than a single chain of entailment. Grades as of the version stamp; the full edition's evidence ledger
carries the full ledger and its dashboard the quarterly indicators that move them.}
\label{fig:props}
\end{figure}
